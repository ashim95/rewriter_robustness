...
class Sst2Processor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        """See base class."""
        """logger.info("LOOKING AT {}".format(os.path.join(data_dir, "train.tsv")))"""
        folder1 = os.path.join(data_dir, "train", "1")
        folder2 = os.path.join(data_dir, "train", "0")
        return self._create_examples_from_folder([folder1, folder2], "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        folder1 = os.path.join(data_dir, "test", "1")
        folder2 = os.path.join(data_dir, "test", "0")
        return self._create_examples_from_folder([folder1, folder2], "dev")
...
class AgNewsProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        ...
        folder1 = os.path.join(data_dir, "train", "1")
        folder2 = os.path.join(data_dir, "train", "0")
        folder3 = os.path.join(data_dir, "train", "2")
        folder4 = os.path.join(data_dir, "train", "3")
        return self._create_examples_from_folder([folder1, folder2, folder3, folder4], "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        folder1 = os.path.join(data_dir, "test", "1")
        folder2 = os.path.join(data_dir, "test", "0")
        folder3 = os.path.join(data_dir, "test", "2")
        folder4 = os.path.join(data_dir, "test", "3")
        return self._create_examples_from_folder([folder1, folder2, folder3, folder4], "dev")
...
def compute_metrics(task_name, preds, labels):
    ...
    if task_name == "imdb" or task_name == "sst2":
